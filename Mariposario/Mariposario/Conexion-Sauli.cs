...
namespace Mariposario {
    ...
    public partial class Conexion{
        ...
        public List<Coleccion> obtenerColecciones(List<Mariposa> mariposas) {
        ...
        public bool insertarColeccion(String id, String nombre, decimal precio, DateTime fecha,Persona dueño, List<Coleccion> colecciones, List<MariposaDeColeccion> mariposas) {
            ...
            //Párametros
            String parametros = "";
            foreach(MariposaDeColeccion m in mariposas) parametros += m.Identificador+",";
            parametros.Remove(parametros.Length-1);
            ...
            try {
                ...
                this.conexion.Close();
                foreach(MariposaDeColeccion m in mariposas) {
        ...
        public bool eliminarColeccion(Coleccion c) {
            ...
            //Párametros
            String parametros = "";
            foreach(MariposaDeColeccion m in c.Mariposas) parametros += m.Identificador+",";
            parametros.Remove(parametros.Length-1);
            ...
            try {
                ...
                foreach(MariposaDeColeccion m in c.Mariposas) {
                    SqlCommand cmd2 = new SqlCommand("dbo.insertarMariposaEnObservacion", this.conexion);
                    cmd2.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd2.Parameters.AddWithValue("@id", m.Identificador);
                    cmd2.Parameters.AddWithValue("@tiempo", 10);
                    this.conexion.Open();
                    cmd2.ExecuteNonQuery();
                    this.conexion.Close();
                }
        ...
        public bool actualizarColeccion(Coleccion c, List<MariposaEnObservacion> mO) {
            ...
            try {
                ...
                foreach(MariposaEnObservacion m in mO) {
                    SqlCommand cmd2 = new SqlCommand("dbo.insertarMariposaEnObservacion", this.conexion);
                    cmd2.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd2.Parameters.AddWithValue("@id", m.Identificador);
                    cmd2.Parameters.AddWithValue("@tiempo", m.TiempoDeObservacion);
                    this.conexion.Open();
                    cmd2.ExecuteNonQuery();
                    this.conexion.Close();
                }
